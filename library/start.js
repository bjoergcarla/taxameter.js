...
function start(taxameter) {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        setInterval(() => {
            ...
            if (taxameter.turSluttetTidspunkt==undefined){
                elementer.pris.innerText = taxameter.timePris+"kr/min + "+taxameter.kmPris+"kr/km + "+taxameter.startPris+"kr";
            }else {
            elementer.pris.innerText = taxameter.beregnPris() + " DKK";}
